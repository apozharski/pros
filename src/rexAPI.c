...
void getJoysticks(void *ignore)
{
	...
	{
		timeStart = millis();
		joyMain.rightVertical.axisValue 		= 	joystickGetAnalog(1,2);
		joyMain.rightHorizontal.axisValue 		= 	joystickGetAnalog(1,1);
		joyMain.leftVertical.axisValue 		= 	joystickGetAnalog(1,3);
		joyMain.leftHorizontal.axisValue 		= 	joystickGetAnalog(1,4);
		...
		joyMain.rightBumper.axisValue 			= 	joystickGetDigitalAxis(1,6);
		joyMain.leftBumper.axisValue 			= 	joystickGetDigitalAxis(1,5);
		joyMain.rightDpad.axisValue 			= 	joystickGetDigitalAxis(1,8);
		joyMain.leftDpad.axisValue 			= 	joystickGetDigitalAxis(1,7);
...
axis* setMotorOutputAxis_lcd()
{
	...
	while(true)
	{
		switch(position)
		{
		AXIS_CASE_LCD(1, joyMain.rightHorizontal)
										AXIS_CASE_LCD(2, joyMain.rightVertical)
										AXIS_CASE_LCD(3, joyMain.leftVertical)
										AXIS_CASE_LCD(4, joyMain.leftHorizontal)
										AXIS_CASE_LCD(5, joyMain.leftBumper)
										AXIS_CASE_LCD(6, joyMain.rightBumper)
										AXIS_CASE_LCD(7, joyMain.leftDpad)
										AXIS_CASE_LCD(8, joyMain.rightDpad)
